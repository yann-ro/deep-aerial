...
rmv data/hit-uav/labels/

printf "0\n1\n2\n3\n4" > data/hit-uav/train/list_label.txt
python3 deep-aerial/dataset/setup/to_coco_format.py -p data/hit-uav/train/labels -l data/hit-uav/train/list_label.txt

printf "0\n1\n2\n3\n4" > data/hit-uav/test/list_label.txt
python3 deep-aerial/dataset/setup/to_coco_format.py -p data/hit-uav/test/labels -l data/hit-uav/test/list_label.txt

printf "0\n1\n2\n3\n4" > data/hit-uav/val/list_label.txt
python3 deep-aerial/dataset/setup/to_coco_format.py -p data/hit-uav/val/labels -l data/hit-uav/val/list_label.txt